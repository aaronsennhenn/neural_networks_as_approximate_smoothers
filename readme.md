...
| `notebooks/` | Contains notebooks for replicating figures |
| `results/` | Stores results obtained from running the empirical evaluation |
| `src/` | Stores adjusted OutcomeWeights functions for neural networks and code used to obtain objects in results folder|
