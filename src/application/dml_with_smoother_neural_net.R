...
#' @export
#' 
dml_with_smoother_neural_net = function(Y,D,X,Z=NULL,
  ...
  supported_smoothers = c("honest_forest", "neural_net")
  ...
  NuPa.hat = NuPa_honest_forest(NuPa = NuPa,
                             ...
                             n_reps=n_reps,
                             ...) }
  if (smoother == "neural_net") {
  NuPa.hat = NuPa_neural_net(NuPa = NuPa,
                                  X,Y,D,Z,
                                  n_cf_folds=n_cf_folds,
                                  n_reps=n_reps,
                                  ...) }
